...
public class ClubMapsActivity extends FragmentActivity
        implements OnMapReadyCallback,
        GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        LocationListener {
    public static Intent getInstance(Context context) {
        return new Intent(context, ClubMapsActivity.class);
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mGoogleMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {;
                Intent intent = new Intent(ClubMapsActivity.this, ClubMainActivity.class);
                intent.putExtra("selected_club", (Club)marker.getTag());
    ...
    public void loadClubsData(String sortType) {
        User currentUser = new UserLocalDataSource(ClubMapsActivity.this).getCurrentUser();
        ...
        Subscription subscription = AppServiceClient.getInstance().getAllClubs(sortType, currentUser.getAuthToken())
                ...
                .subscribe(new Action1<BaseResponse<ArrayList<Club>>>() {
                    ...
                    public void onSafetyError(BaseException error) {
                        Toast.makeText(ClubMapsActivity.this, error.getErrorType() + error.getLocalizedMessage() + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void onLocationChanged(Location location)
    {
        ...
        for (Club c : listClubs) {
            if (c.getLatitude() != null && c.getLongitude() != null) {
                Location l1 = new Location("One");
                l1.setLatitude(c.getLatitude());
                l1.setLongitude(c.getLongitude());
                ...
                LatLng clubLatLng = new LatLng(c.getLatitude(), c.getLongitude());

                MarkerOptions markerOptions = new MarkerOptions();

                markerOptions.position(clubLatLng);
                markerOptions.title(c.getName());
                markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE));
                markerOptions.snippet("Number of Member: " + c.getAllMembersCount());
                mCurrLocationMarker = mGoogleMap.addMarker(markerOptions);
                mCurrLocationMarker.setTag(c);
        ...
        //move map camera
        mGoogleMap.moveCamera(CameraUpdateFactory.newLatLngBounds(bounds, 300));
    }
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(ClubMapsActivity.this,
